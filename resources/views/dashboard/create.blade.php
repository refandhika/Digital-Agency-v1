        ...
        <div class="container min-h-screen mt-24">
            <section class="max-w-full bg-white">
                <div class="mx-auto w-4/5 flex flex-row flex-wrap">
                    ...
                    <h2 class="text-2xl font-bold w-full my-4">New Service</h2>
                    <form action="{{ route('dashboard.store') }}" method="POST" enctype="multipart/form-data" class="w-full">
                      @csrf 
                      <div class="border border-gray-100 rounded-2xl p-4 inline-block w-full">
                        <div class="block">
                          <label class="w-full text-gray-600">Service Name</label>
                          <input class="border border-gray-400 w-full p-2" type="text" name="name" placeholder=""/>
                        </div>
                        <div class="block">
                          <label class="w-full text-gray-600">Description</label>
                          <textarea class="border border-gray-400 w-full p-2" row="4" name="description" placeholder=""></textarea>
                        </div>
                        <div class="block">
                          <label class="w-full text-gray-600">Icon</label>
                          <input class="border border-gray-400 w-full p-2" type="text" name="icon" placeholder=""/>
                        </div>
                        <div class="block">
                          <label class="w-full text-gray-600">Image URL</label>
                          <input class="border border-gray-400 w-full p-2" type="text" name="image" placeholder=""/>
                        </div>
                      </div>
